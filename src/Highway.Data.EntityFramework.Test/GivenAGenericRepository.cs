...
public class GivenAGenericRepository
{
    ...
    public void Setup()
    {
        var options = new DbContextOptionsBuilder()
                      .UseSqlServer("Data Source=(localDb);Initial Catalog=Highway.Data.Test.Db;Integrated Security=True", opts => opts.EnableRetryOnFailure())
                      .Options;
    ...
    public void Should_Execute_A_Query_Object_And_Pull_The_First_Object()
    {
        ...
        //Act
        var result = _target.Find(new FindFoo()).FirstOrDefault();
    ...
    public void Should_Execute_Query_Objects()
    {
        ...
        //Act
        var result = _target.Find(new FindFoo());
    ...
    public void Should_Execute_Scalar_Objects_That_Return_Objects()
    {
        ...
        //Act
        var result = _target.Find(new ScalarIntTestQuery());
